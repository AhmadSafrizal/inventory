<template>
  ...
  >
    <h3 class="text-lg font-semibold mb-4">Incoming Transactions</h3>
    <div class="mb-4">
    ...
    <div class="overflow-x-auto" id="pdf-content">
      <h3 class="pdf-title">Incoming Transaction</h3>
...
import AddInTransactionModal from "./AddInTransactionModal.vue";
